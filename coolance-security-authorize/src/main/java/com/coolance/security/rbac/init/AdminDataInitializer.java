...
import com.coolance.security.rbac.domain.*;
...
public class AdminDataInitializer extends AbstractDataInitializer {
     ...
     * (non-Javadoc)
     *
     * @see com.coolance.security.rbac.init.AbstractDataInitializer#doInit()
     */
    @Override
...
//		createResource("资源管理", "resource", "", menu1);
     ...
     * (non-Javadoc)
     *
     * @see com.coolance.security.rbac.init.AbstractDataInitializer#isNeedInit()
     */
    @Override
